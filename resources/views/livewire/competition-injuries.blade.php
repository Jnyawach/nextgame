                        ...
                        <a href="#" title="{{$injury->id}}" class="text-decoration-none">
                            <div class="card fixture transform-card injury">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-3">
                                            <img src="{{$injury->avatar}}" class="img-fluid rounded-circle"
                                                 title="{{$injury->name}}" alt="{{$injury->name}}">
                                        </div>
                                        <div class="col-9">
                                            <h6 class="fw-bold">{{$injury->name}}</h6>
                                            <p class="p-0 m-0"><span>Injury:</span> {{$injury->type}}</p>
                                            <small><span>Club:</span> {{ \Illuminate\Support\Str::limit($injury->team, 15, $end='...') }}
                                            </small>
                                        </div>
                                    </div>
                                </div>
